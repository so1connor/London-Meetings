...
//  London Meetings
//
//  Created by Steve O'Connor on 29/07/2018.
...
class PopupTableViewController: UITableViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        delegate = self.presentingViewController as? DayDelegate
    }
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        print("popup row", indexPath.row)
//        print(delegate)
        delegate?.changedDay(day: indexPath.row)
